...
public class Actor extends GameObject{
    ...
    public int testGravity;
    public static int MOVING_SPEED_FAT = 16;
    public static int MOVING_SPEED_SLIM = 16;
    ...
    public void triggerTrap(Floor floor){
        floor.setTriggered(true);
    }
